                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" type="tel" id="telnum" name="telnum" placeholder="Phone Number" className="form-control"
                                    ...
                                    <Errors model=".telnum" className="text-danger" show="touched"
                                            messages={
                                                { required: 'Required ',
                                                    ...
                                                    isNumber: 'Must contain only number'
                                                }
                                            }
                                    />
                                </Col>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".email" type="email" id="email" name="email" placeholder="Email" className="form-control"
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" id="message" name="message" rows="10" placeholder="Your feedback" className="form-control" />
                                </Col>
                            </Row>
                            <Row className="form-group">
